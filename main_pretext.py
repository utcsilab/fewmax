...
from dataset_mri import MRI_Patch
...
parser.add_argument('--tb', action='store_true',
                    help='tensorboard')
parser.add_argument('--save', default='save2', type=str,
                    help='save root')
...
parser.add_argument('--dataset', default='imagenet', type=str, choices=['mri_knee', 'mri_brain', 'imagenet', 'imagenet_val', 'visda'],
                    help='dataset to use')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset in ['imagenet', 'imagenet_val']:
        ...
        #import folder
        train_dataset_main = datasets.ImageFolder(traindir, TwoCropsTransform(transforms.Compose(train_transform_list)))
        ...
        train_dataset = torch.utils.data.dataset.Subset(train_dataset_main, indexes[::50])
    elif args.dataset == 'mri_knee':
        train_dataset = MRI_Patch(data_type='knee', ratio=0.05, training=True)
    elif args.dataset == 'mri_brain':
        train_dataset = MRI_Patch(data_type='brain', ratio=0.05, training=True)
    elif args.dataset == 'cifar10':
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if is_milestone:
                ...
                }, is_milestone=False, filename='{}/checkpoint_{}.pth'.format(args.model_name, epoch), epoch=epoch+1)
